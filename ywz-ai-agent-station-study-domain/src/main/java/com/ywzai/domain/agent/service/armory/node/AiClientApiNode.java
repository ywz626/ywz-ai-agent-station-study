...
/**
 * @Author: ywz @CreateTime: 2025-09-19 @Description: 注册aiclientapi节点 @Version: 1.0
 */
@Slf4j
@Service
    ...
    for (AiClientApiVO api : apiList) {
      OpenAiApi openAiApi =
          OpenAiApi.builder()
              ...
              .build();
      registerBean(
          AiAgentEnumVO.AI_CLIENT_API.getBeanName(api.getApiId()), OpenAiApi.class, openAiApi);
    }
    //        return "调用成功";
    return router(armoryCommandEntity, dynamicContext);
  }
