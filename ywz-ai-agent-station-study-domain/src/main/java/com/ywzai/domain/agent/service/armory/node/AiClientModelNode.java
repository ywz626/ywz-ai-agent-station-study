...
/**
 * @Author: ywz @CreateTime: 2025-09-20 @Description: Aimodel装配节点 @Version: 1.0
 */
@Service
@Slf4j
public class AiClientModelNode extends AbstractArmorySupport {

  @Resource private AiClientAdvisorNode aiClientAdvisorNode;
  ...
  protected String doApply(
      ...
      throws Exception {
    List<AiClientModelVO> aiClientModelVOList =
      ...
      if (toolMcpIds != null && !toolMcpIds.isEmpty()) {
        for (String toolMcpId : toolMcpIds) {
          McpSyncClient mcpSyncClient =
              getBean(AiAgentEnumVO.AI_CLIENT_TOOL_MCP.getBeanName(toolMcpId));
          mcpSyncClientList.add(mcpSyncClient);
        }
      }
      // 获取openaiApi
      OpenAiApi openAiApi =
          getBean(AiAgentEnumVO.AI_CLIENT_API.getBeanName(aiClientModelVO.getApiId()));
      //            OpenAiApi openAiApi =
      // dynamicContext.getValue(AiAgentEnumVO.AI_CLIENT_API.getBeanName(aiClientModelVO.getApiId()));
      // 构建openaiChatModel
          ...
          OpenAiChatModel.builder()
              ...
              .defaultOptions(
                  OpenAiChatOptions.builder()
                      ...
                      .toolCallbacks(
                          new SyncMcpToolCallbackProvider(mcpSyncClientList).getToolCallbacks())
                      .build())
              .build();
      // 注册openaiChatModel
      registerBean(
          AiAgentEnumVO.AI_CLIENT_MODEL.getBeanName(aiClientModelVO.getModelId()),
  ...
  @Override
  public StrategyHandler<ArmoryCommandEntity, DefaultArmoryStrategyFactory.DynamicContext, String>
      get(
          ArmoryCommandEntity armoryCommandEntity,
          DefaultArmoryStrategyFactory.DynamicContext dynamicContext)
          throws Exception {
