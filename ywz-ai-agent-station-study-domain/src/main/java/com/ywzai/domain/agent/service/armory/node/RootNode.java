...
/**
 * @Author: ywz @CreateTime: 2025-09-19 @Description: 规则树模型根节点 @Version: 1.0
 */
@Service("armoryRootNode")
public class RootNode extends AbstractArmorySupport {
  @Resource private AiClientApiNode aiClientApiNode;

  @Resource private Map<String, ILoadDataStrategy> loadDataStrategyMap;
