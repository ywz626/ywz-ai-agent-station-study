...
public class FlowAgentExecuteStrategy implements IExecuteStrategy {
    ...
    public void execute(ExecuteCommandEntity requestParameter, ResponseBodyEmitter emitter) throws Exception {
        // 获取策略处理链的根节点
        StrategyHandler<ExecuteCommandEntity, DefaultFlowAgentExecuteStrategyFactory.DynamicContext, String> rootNode = defaultFlowAgentExecuteStrategyFactory.get();
