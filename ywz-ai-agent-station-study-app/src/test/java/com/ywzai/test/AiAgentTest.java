...
//                        .build())
    ...
    public McpSyncClient stdioMcpClient() {
        ...
        var stdioParams = ServerParameters.builder( "npx.cmd")
                .args("-y", "@modelcontextprotocol/server-filesystem", "C:\\Users\\ywz\\Desktop", "C:\\Users\\ywz\\Desktop")
                .build();
    ...
    public McpSyncClient sseMcpClient01() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://81.70.145.235:8102").build();
    ...
    public McpSyncClient sseMcpClient02() {
        ...
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://81.70.145.235:8101").build();
