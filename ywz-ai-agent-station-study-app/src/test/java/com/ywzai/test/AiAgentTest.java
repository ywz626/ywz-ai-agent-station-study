...
public class AiAgentTest {
                ...
                OpenAiChatOptions.builder()
                    ...
                    .toolCallbacks(
                        new SyncMcpToolCallbackProvider(
                                stdioMcpClient(), sseMcpClient01(), sseMcpClient02())
                            .getToolCallbacks())
                    .build())
            .build();
        ...
        ChatClient.builder(chatModel)
            .defaultSystem(
                """
                        ...
                        """)
            //                .defaultToolCallbacks(new
            // SyncMcpToolCallbackProvider(stdioMcpClient(), sseMcpClient01(),
  ...
  public void test_client03() {
    ...
    String content =
        chatClient01
            ...
            .advisors(
                a ->
                    a.param(CHAT_MEMORY_CONVERSATION_ID_KEY, "chatId-101")
        ...
        ChatClient.builder(chatModel)
            .defaultSystem(
                """
                        ...
                        """)
            //                .defaultTools(new SyncMcpToolCallbackProvider(sseMcpClient01(),
            // sseMcpClient02()))
            .defaultAdvisors(
                PromptChatMemoryAdvisor.builder(
                        MessageWindowChatMemory.builder().maxMessages(100).build())
  ...
  public McpSyncClient sseMcpClient01() {
    ...
    HttpClientSseClientTransport sseClientTransport =
        HttpClientSseClientTransport.builder("http://81.70.145.235:8102").build();

    McpSyncClient mcpSyncClient =
        McpClient.sync(sseClientTransport).requestTimeout(Duration.ofMinutes(180)).build();
  ...
  public McpSyncClient sseMcpClient02() {
    ...
    HttpClientSseClientTransport sseClientTransport =
        HttpClientSseClientTransport.builder("http://81.70.145.235:8101").build();
