...
/**
 * @Author: ywz @CreateTime: 2025-10-15 @Description: Flow模式Agent执行测试 @Version: 1.0
 */
@SpringBootTest
@RunWith(SpringRunner.class)
@Slf4j
public class AgentFlowChainTest {

  @Resource Map<String, IExecuteStrategy> executeStrategyMap;

  @Test
  public void test_01() throws Exception {
    IExecuteStrategy flowAgentExecuteStrategy = executeStrategyMap.get("flowAgentExecuteStrategy");
    ...
    executeCommandEntity.setMessage(
        """
                ...
                """);
    executeCommandEntity.setMaxStep(10);
    executeCommandEntity.setSessionId("ywz02");
    flowAgentExecuteStrategy.execute(executeCommandEntity, new ResponseBodyEmitter());
  }
}
