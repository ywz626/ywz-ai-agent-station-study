package com.ywzai.test.advisors;
...
public class RagAnswerAdvisor implements BaseAdvisor {
  ...
  public ChatClientRequest before(ChatClientRequest chatClientRequest, AdvisorChain advisorChain) {
    ...
    SearchRequest searchRequestToUse =
        SearchRequest.from(this.searchRequest)
            .query(userText)
    ...
    String advisedUserText =
        new PromptTemplate(userText + this.userTextAdvise).render(advisedUserParams);
  ...
  public ChatClientResponse after(
    ...
    chatResponseBuilder.metadata(
        "qa_retrieved_documents", chatClientResponse.context().get("qa_retrieved_documents"));
  ...
  public ChatClientResponse adviseCall(
    ...
    ChatClientResponse chatClientResponse =
        callAdvisorChain.nextCall(this.before(chatClientRequest, callAdvisorChain));
