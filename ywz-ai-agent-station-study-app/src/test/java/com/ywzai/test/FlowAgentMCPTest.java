...
/**
 * @author xiaofuge bugstack.cn @小傅哥 2025/8/9 09:15
 */
@Slf4j
...
public class FlowAgentMCPTest {
        ...
        OpenAiChatModel.builder()
            ...
            .defaultOptions(
                OpenAiChatOptions.builder()
                    ...
                    .toolCallbacks(
                        new SyncMcpToolCallbackProvider(stdioMcpClient_Grafana())
                            .getToolCallbacks())
                    .build())
            .build();

    ChatResponse call =
        chatModel.call(Prompt.builder().messages(new UserMessage("有哪些工具可以使用")).build());
   ...
   * https://www.npmjs.com/package/@awesome-ai/elasticsearch-mcp npm i @awesome-ai/elasticsearch-mcp
   */
  ...
  public McpSyncClient sseMcpClient_BaiduSearch() {
    HttpClientSseClientTransport sseClientTransport =
        HttpClientSseClientTransport.builder("http://appbuilder.baidu.com/v2/ai_search/mcp/")
            .sseEndpoint(
                "sse?api_key=bce-v3/ALTAK-3zODLb9qHozIftQlGwez5/2696e92781f5bf1ba1870e2958f239fd6dc822a4")
            .build();
