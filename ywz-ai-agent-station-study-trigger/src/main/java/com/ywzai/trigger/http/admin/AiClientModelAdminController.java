...
public class AiClientModelAdminController implements IAiClientModelAdminService {
  ...
  public Response<Boolean> updateAiClientModelByModelId(
      @RequestBody AiClientModelRequestDTO request) {
    try {
  ...
  public Response<List<AiClientModelResponseDTO>> queryAiClientModelsByApiId(
    ...
    try {
      ...
      // PO转DTO
      List<AiClientModelResponseDTO> responseDTOs =
          aiClientModels.stream()
