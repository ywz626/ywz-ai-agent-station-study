...
public class AiClientRagOrderAdminController implements IAiClientRagOrderAdminService {
  ...
  @Resource private IRagService ragService;
  ...
  public Response<Boolean> updateAiClientRagOrderById(
      @RequestBody AiClientRagOrderRequestDTO request) {
    try {
  ...
  public Response<Boolean> updateAiClientRagOrderByRagId(
      @RequestBody AiClientRagOrderRequestDTO request) {
    try {
  ...
  public Response<AiClientRagOrderResponseDTO> queryAiClientRagOrderById(@PathVariable Long id) {
    try {
      ...
      AiClientRagOrderResponseDTO responseDTO =
          convertToAiClientRagOrderResponseDTO(aiClientRagOrder);
  ...
  public Response<AiClientRagOrderResponseDTO> queryAiClientRagOrderByRagId(
  ...
  public Response<List<AiClientRagOrderResponseDTO>> queryEnabledAiClientRagOrders() {
    try {
      ...
      List<AiClientRagOrderResponseDTO> responseDTOs =
          aiClientRagOrders.stream()
  ...
  public Response<List<AiClientRagOrderResponseDTO>> queryAiClientRagOrdersByKnowledgeTag(
    ...
    try {
      ...
      List<AiClientRagOrder> aiClientRagOrders =
          aiClientRagOrderDao.queryByKnowledgeTag(knowledgeTag);
      List<AiClientRagOrderResponseDTO> responseDTOs =
          aiClientRagOrders.stream()
              .map(this::convertToAiClientRagOrderResponseDTO)
              .collect(Collectors.toList());
  ...
  public Response<List<AiClientRagOrderResponseDTO>> queryAiClientRagOrdersByStatus(
  ...
  public Response<List<AiClientRagOrderResponseDTO>> queryAiClientRagOrderList(
    ...
    try {
      ...
      // 根据查询条件过滤
      List<AiClientRagOrder> filteredOrders =
          aiClientRagOrders.stream()
              .filter(
                  order -> {
                    boolean match = true;
  ...
  public Response<Boolean> uploadRagFile(
  ...
  /** PO转DTO */
  private AiClientRagOrderResponseDTO convertToAiClientRagOrderResponseDTO(
      AiClientRagOrder aiClientRagOrder) {
