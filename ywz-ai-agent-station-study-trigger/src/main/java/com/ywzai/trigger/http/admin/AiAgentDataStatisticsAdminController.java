 ...
 * 数据统计
 *
 * @author xiaofuge bugstack.cn @小傅哥 2025/10/4 10:33
 */
@Slf4j
@RestController
...
public class AiAgentDataStatisticsAdminController implements IAiAgentDataStatisticsAdminService {
  ...
  public Response<DataStatisticsResponseDTO> getDataStatistics() {
    try {
      ...
      // 构建响应数据
      DataStatisticsResponseDTO responseDTO =
          DataStatisticsResponseDTO.builder()
      ...
      log.info(
          "系统数据统计获取成功：智能体数量={}, 客户端数量={}, MCP工具数量={}, 系统提示数量={}, 知识库数量={}, 顾问数量={}, 模型数量={}",
          agentCount,
          clientCount,
          mcpToolCount,
          systemPromptCount,
