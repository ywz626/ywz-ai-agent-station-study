...
public interface IAiClientSystemPromptAdminService {
   ...
   * @return 系统提示词配置列表
   */
  Response<List<AiClientSystemPromptResponseDTO>> queryAiClientSystemPromptsByPromptName(
      String promptName);
   ...
   * @return 系统提示词配置列表
   */
  Response<List<AiClientSystemPromptResponseDTO>> queryAiClientSystemPromptList(
      AiClientSystemPromptQueryRequestDTO request);
}
