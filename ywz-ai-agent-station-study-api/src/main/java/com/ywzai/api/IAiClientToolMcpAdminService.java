...
public interface IAiClientToolMcpAdminService {
   ...
   * @return MCP客户端配置列表
   */
  Response<List<AiClientToolMcpResponseDTO>> queryAiClientToolMcpsByTransportType(
   ...
   * @return MCP客户端配置列表
   */
  Response<List<AiClientToolMcpResponseDTO>> queryAiClientToolMcpList(
      AiClientToolMcpQueryRequestDTO request);
}
