...
/**
 * @Author: ywz @CreateTime: 2025-09-18 @Description: 智能体流程配置DAO接口 @Version: 1.0
 */
@Mapper
public interface IAiAgentFlowConfigDao {
   ...
   * @return 流程配置对象
   */
  AiAgentFlowConfig queryByAgentIdAndClientId(
      @Param("agentId") Long agentId, @Param("clientId") Long clientId);
